...
@synthesize quickLinkSelectedIndex;
@synthesize yearsDic;
...
{
    [super viewDidLoad];
	isScreenLoadedForFirstTime = YES;
...
- (void)viewDidAppear:(BOOL)animated{
	NSError *error = nil;
    [[GANTracker sharedTracker] trackPageview:@"Business Record Detail Page" withError:&error];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
	...
	if(indexPath.row==0) {
		...
		self.vDemoGPrf.frame=(isExpanded)?CGRectMake(0, 0, 320, 265):CGRectMake(0, 0, 320, 30);
		...
		self.vIndPrfl.frame=(isExpanded)?CGRectMake(0, 0, 320, 240):CGRectMake(0, 0, 320, 30);
		...
		self.vOwnerShip.frame=(isExpanded)?CGRectMake(0, 0, 320, 218):CGRectMake(0, 0, 320, 30);
		...
		self.vOtherImpInfo.frame=(isExpanded)?CGRectMake(0, 0, 320, 218):CGRectMake(0, 0, 320, 30);
		...
		self.vCrpLnk.frame=(isExpanded)?CGRectMake(0, 0, 320, 140):CGRectMake(0, 0, 320, 30);
		...
		self.vQRCode.frame=(isExpanded)?CGRectMake(0, 0, 320, 273):CGRectMake(0, 0, 320, 30);
		...
		self.vRevenueTrend.frame=(isExpanded)?CGRectMake(0, 0, 320, 660):CGRectMake(0, 0, 320, 30);
		...
		self.vCompetitors.frame=(isExpanded)?CGRectMake(0, 0, 320, 253):CGRectMake(0, 0, 320, 30);
		...
		self.vNearBy.frame=(isExpanded)?CGRectMake(0, 0, 320, 253):CGRectMake(0, 0, 320, 30);
		...
		self.vExDir.frame=(isExpanded)?CGRectMake(0, 0, 320, 253):CGRectMake(0, 0, 320, 30);
